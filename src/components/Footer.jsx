  ...
  return (
    <footer className="site-footer">
      <div className="footer-content">
        <div>
          <div className="nav-brand" style={{ marginBottom: '1rem', cursor: 'default' }}>
            <Activity color="var(--teal)" size={20} /> IntelliAssess
          </div>
      ...
      <div className="footer-bottom" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>&copy; {new Date().getFullYear()} IntelliAssess. Institutional Grade Analysis.</div>
        <div style={{ color: 'var(--text-tertiary)', fontSize: '0.8125rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          Crafted with <span style={{ color: 'var(--rose)' }}>♥</span> by <strong>Karan Patil</strong> & <strong>Krishna Hasara</strong> for the IIT Hyderabad Hackathon
        </div>
      </div>
    </footer>
  );
